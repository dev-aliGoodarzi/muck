...
export const CalendarDataGenerator = (
  ...
  for (let i = 0; i < Object.keys(days).length; i++) {
    activities.push({
      ...
      total_time: randomNumberGenerator(),
      tss_actual: randomNumberGenerator(),
      tss_planned: randomNumberGenerator(),
      total_time_planned: randomNumberGenerator(),
      description: `desc ${i}`,
      distance: randomNumberGenerator(),
      calories: randomNumberGenerator(),
      distance_planned: randomNumberGenerator(),
      order_on_day: i,
